  ...
  return (
    <div className="space-y-8 relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-[minmax(140px,auto)]">
        <StaggerReveal baseDelay={100} staggerInterval={120}>
          {/* Hero card - spans 2 columns and 2 rows */}
          <Card className="glass sm:col-span-2 lg:col-span-2 lg:row-span-2 relative overflow-hidden group hover:shadow-[0_8px_40px_oklch(0.75_0.18_180_/_0.15)] transition-all duration-500">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-base font-medium font-display text-card-foreground/80">
                Percakapan Aktif
              </CardTitle>
          ...
          {/* Card 2 */}
          <Card className="glass relative overflow-hidden group hover:shadow-[0_4px_24px_oklch(0.78_0.15_65_/_0.12)] transition-all duration-500 hover:-translate-y-0.5">
          ...
          {/* Card 3 */}
          <Card className="glass relative overflow-hidden group hover:shadow-[0_4px_24px_oklch(0.65_0.2_330_/_0.12)] transition-all duration-500 hover:-translate-y-0.5">
          ...
          {/* Card 4 */}
          <Card className="glass sm:col-span-2 lg:col-span-2 relative overflow-hidden group hover:shadow-[0_4px_24px_oklch(0.75_0.18_180_/_0.1)] transition-all duration-500 hover:-translate-y-0.5">
