...
export function runGuardInput(input: string, blockedPatterns: string[]): SanitizeResult {
  try {
...
export function runGuardOutput(output: string, blockedOutputPatterns: string[], systemPromptHash?: string | null): ValidationResult {
  try {
